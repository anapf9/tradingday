<template>
    <div>
        ...
        <v-sheet :elevation="6" class="pa-2" color="primary" >
            ...
            <span class="white--text font-weight-light"> Você pode salvar e carregar os dados</span>
        </v-sheet>
        <v-sheet :elevation="6" class="pa-2 success darken-1 mt-3">
            <v-icon class="white--text mr-3">info</v-icon>
            <span class="white--text font-weight-light"> Clique em finalizar dia para começar um novo dia</span>
        </v-sheet>
